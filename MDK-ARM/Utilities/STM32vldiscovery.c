...
/** @defgroup STM32vldiscovery_Private_Variables
  * @{
  */ 
GPIO_TypeDef* GPIO_PORT[LEDn] = {LED3_GPIO_PORT, LED4_GPIO_PORT, CAMERA_GPIO_PORT, DOOR_GPIO_PORT, MAIN_GREEN_GPIO_PORT, MAIN_BLUE_GPIO_PORT};

const uint16_t GPIO_PIN[LEDn] = {LED3_PIN, LED4_PIN, CAMERA_PIN, DOOR_PIN, MAIN_GREEN_PIN, MAIN_BLUE_PIN};

const uint32_t GPIO_CLK[LEDn] = {LED3_GPIO_CLK, LED4_GPIO_CLK, CAMERA_GPIO_CLK, DOOR_GPIO_CLK, MAIN_GREEN_GPIO_CLK, MAIN_BLUE_GPIO_CLK};
